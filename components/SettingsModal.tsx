            ...
            {activeTab === 'keys' && (
              <div className="space-y-6 animate-in slide-in-from-right-4 duration-300">
                <div className="bg-orange-50 dark:bg-orange-900/20 border border-orange-100 dark:border-orange-800 rounded-lg p-4 flex gap-3">
                  ...
                  <div>
                    <h4 className="text-sm font-semibold text-orange-800 dark:text-orange-300">Manual Override</h4>
                    <p className="text-xs text-orange-700 dark:text-orange-400 mt-1 leading-relaxed">
                      Only add keys here if the automatic configuration fails. These keys will be stored locally on your device.
                    </p>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-lg bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all font-mono text-sm dark:text-white"
                    placeholder="sk-or-v1-..."
                  />
                  <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">Required for chat functionality.</p>
                </div>
              </div>
            )}
